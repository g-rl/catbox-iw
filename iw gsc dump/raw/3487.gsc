...
_id_12E10( var_0 )
{
    ...
    var_0._id_117E9 = var_0._id_117E9 + ( level._id_8DA2 - var_1 ) / level._id_8DA2 * 100;

    if ( isdefined( self.attacker ) && var_0 == self.attacker )
        var_0._id_117E9 = var_0._id_117E9 + 100;

    if ( isplayer( var_0 ) )
        var_0._id_117E9 = var_0._id_117E9 + var_0.score * 4;

    if ( isdefined( var_0._id_202C ) )
        var_0._id_117E9 = var_0._id_117E9 - var_0._id_202C;
...
{
    self endon( "death" );
    self._id_DDBF = self._id_DDBF + var_0;
    wait 4.0;
    self._id_DDBF = self._id_DDBF - var_0;
}
...
_id_6D7A( var_0 )
{
    ...
    if ( isdefined( var_8 ) && isalive( var_8 ) )
    {
        if ( isdefined( var_8._id_202C ) )
            var_8._id_202C = var_8._id_202C + 100;
        else
            var_8._id_202C = 100;
    }
...
_id_8D52( var_0 )
{
    ...
    while ( isdefined( var_1._id_0334 ) )
    {
        ...
        {
            self._id_5275 = self._id_5275 * 0.5;
            self._id_526F = self._id_526F * 0.5;
        }
