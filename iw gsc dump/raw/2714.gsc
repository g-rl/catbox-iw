...
playerkilled_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    {
        var_28 = [[ level.bot_funcs["get_attacker_ent"] ]]( var_1, var_0 );

        if ( isdefined( var_28 ) )
        {
            if ( scripts\mp\utility\game::isaigameparticipant( var_2 ) )
                var_2 botmemoryevent( "death", var_6, var_28.origin, var_2.origin, var_28 );
            ...
            if ( scripts\mp\utility\game::isaigameparticipant( var_1 ) )
            {
                ...
                if ( var_29 )
                    var_1 botmemoryevent( "kill", var_6, var_28.origin, var_2.origin, var_2 );
            }
        }
    }
    ...
    if ( scripts\mp\utility\game::_id_9E6C( var_32 ) || isdefined( var_0._id_110E8 ) )
    {
        var_34 = undefined;
        ...
        else if ( isdefined( var_0._id_110E8 ) )
        {
            if ( isdefined( var_0._id_110E8._id_1318B ) && var_0._id_110E8._id_1318B > 0 )
                var_34 = var_0._id_110E8._id_1318B;
        }

        if ( isdefined( var_34 ) )
        {
            var_35 = level._id_110EC.rarity[var_34];
            var_36 = level._id_110EC._id_E76D[var_34];

            if ( var_32 != "none" )
            {
                var_32 = var_6 + "+loot" + var_36;
                var_33 = "MOD_SCORESTREAK";
            }

            var_2.killsteakvariantattackerinfo = spawnstruct();
            var_2.killsteakvariantattackerinfo._id_92B8 = var_34;
            var_2.killsteakvariantattackerinfo.rarity = var_35;
        }
    }

    if ( isdefined( var_32 ) && scripts\mp\utility\game::_id_821D( var_32 ) == "iw7_axe_mp" && isdefined( var_1 ) && var_1 getweaponammoclip( var_32 ) > 0 )
        var_33 = "MOD_IMPACT";

    obituary( var_2, var_1, var_32, var_33 );
    var_37 = 0;
    var_38 = 1;
    var_2 scripts\mp\clientmatchdata::_id_AFD5( var_1 );
    var_39 = var_2._id_B3E3;

    if ( !isdefined( var_39 ) )
        var_39 = level._id_B4AF - 1;

    var_2 scripts\mp\matchdata::_id_AFD5( var_39, var_1, var_3, var_5, var_6, var_15, var_8 );
    ...
    else if ( !isplayer( var_1 ) || isplayer( var_1 ) && var_5 == "MOD_FALLING" && ( !isdefined( var_2._id_115FC ) && !var_2._id_115FC ) )
    {
        ...
        _id_89FC( var_1, var_39, var_5, var_8 );
    ...
    else
    {
        ...
        if ( isai( var_2 ) && isdefined( level.bot_funcs ) && isdefined( level.bot_funcs["should_do_killcam"] ) )
            var_37 = var_2 [[ level.bot_funcs["should_do_killcam"] ]]();

        if ( isdefined( level.disable_killcam ) && level.disable_killcam )
            var_37 = 0;

        _id_89CA( var_39, var_1, var_0, var_6, var_5, var_2, var_4 );
    ...
    if ( isplayer( var_1 ) && var_1 != self && ( !level.teambased || level.teambased && self.team != var_1.team ) )
    {
        if ( var_40 && isdefined( var_41 ) )
            ...
            var_42 = self._id_A978;

        var_42 = scripts\mp\utility\game::_id_13CA1( var_42, var_0 );
        thread scripts\mp\gamelogic::_id_11AF7( var_42, var_5 );
    ...
    {
        var_44 = scripts\mp\utility\game::_id_8234( var_6 );
        var_45 = var_1 _meth_8519( var_6 );

        if ( isdefined( var_44 ) && var_44 == "iw7_rvn" && scripts\mp\utility\game::istrue( var_45 ) && var_5 == "MOD_MELEE" )
        {
            var_10 = var_2 _meth_8231( var_1, "MOD_EXPLOSIVE", var_6, var_8, var_7 );
            var_46 = getweaponvariantindex( var_6 );
    ...
    if ( !isdefined( self._id_C026 ) && isdefined( var_2._id_2C09 ) )
    {
        ...
        if ( scripts\engine\utility::_id_9D74( var_5 ) && scripts\mp\utility\game::_id_821D( var_6 ) == "iw7_atomizer_mp" || var_6 == "nuke_mp" )
        {
            ...
            var_2._id_2C09 thread scripts\mp\archetypes\archassassin_utility::_id_CEF1( var_47 );
        ...
        if ( var_2 isonladder() || var_2 _meth_81AD() || !var_2 isonground() || isdefined( var_2.nuked ) || isdefined( var_2._id_4C87 ) || scripts\mp\utility\game::_id_9F13() )
        {
            ...
            if ( !var_48 || scripts\mp\utility\game::_id_9F13() )
            {
    ...
    var_2 thread [[ level._id_C577 ]]( var_0, var_1, var_3, var_5, var_6, var_7, var_8, var_9, var_10, var_39 );

    if ( isai( var_2 ) && isdefined( level.bot_funcs ) && isdefined( level.bot_funcs["on_killed"] ) )
        var_2 thread [[ level.bot_funcs["on_killed"] ]]( var_0, var_1, var_3, var_5, var_6, var_7, var_8, var_9, var_10, var_39 );

    if ( scripts\mp\utility\game::_id_9E0E( var_1 ) )
        var_49 = var_1 getentitynumber();
    else
        var_49 = -1;

    if ( !isdefined( var_43 ) )
        var_43 = var_2 scripts\mp\killcam::_id_7F32( var_1, var_0, var_6 );
    ...
    if ( isdefined( level._id_B3FC ) && isdefined( var_0 ) && isplayer( var_0 ) && scripts\engine\utility::_id_9D74( var_5 ) )
    {
        ...
        self._id_D37E[self._id_D37E.size] = var_55;
        var_56 = 0.0;

        if ( isdefined( self._id_658D ) )
            var_56 = gettime() - self._id_658D;

        if ( !isdefined( self._id_658E ) )
            self._id_658E = [];

        self._id_658E[self._id_658E.size] = var_56;
    ...
    if ( isdefined( var_43 ) )
    {
        ...
        var_58 = var_43._id_0064;

        if ( !isdefined( var_58 ) )
            var_58 = 0;
    }

    var_59 = var_5 == "MOD_IMPACT" || var_5 == "MOD_HEADSHOT" && isdefined( var_0 ) || var_5 == "MOD_GRENADE" || isdefined( var_2 ) && isdefined( var_2._id_1117F ) && isdefined( var_0 ) && var_2._id_1117F == var_0 || var_6 == "throwingknifec4_mp";
    ...
    if ( level.recordfinalkillcam && var_38 )
    {
        if ( ( !isdefined( level.disable_killcam ) || !level.disable_killcam ) && var_5 != "MOD_SUICIDE" && !( !isdefined( var_1 ) || var_1.classname == "trigger_hurt" || var_1.classname == "worldspawn" || var_1 == var_2 ) )
            scripts\mp\finalkillcam::recordfinalkillcam( 5.0, var_2, var_1, var_49, var_0, var_57, var_58, var_59, var_6, var_14, var_9, var_5 );
    }
    ...
    if ( !var_11 )
    {
        ...
        var_61 = scripts\mp\playerlogic::_id_1193A( 1 );

        if ( var_61 < 1 )
            var_61 = 1;

        var_2 thread scripts\mp\playerlogic::_id_D81E( var_61 );
        wait 1.75;

        if ( var_37 )
            var_37 = !scripts\mp\finalkillcam::_id_10266( 0.5 );
    ...
    var_37 = var_37 && !var_2 scripts\mp\battlebuddy::_id_3876();

    if ( !( isdefined( var_2._id_3881 ) && var_2._id_3881 ) && var_37 && level._id_A636 && game["state"] == "playing" && !var_2 scripts\mp\utility\game::isusingremote() && !level.showingfinalkillcam )
    {
        ...
        var_2 scripts\mp\killcam::_id_A636( var_0, var_60, var_49, var_57, var_58, undefined, var_59, var_6, var_62 + var_14, var_9, var_61, scripts\mp\gamelogic::_id_11939(), var_1, var_2, var_5, var_65, var_66 );
    }
