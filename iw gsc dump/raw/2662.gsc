...
_id_10A35( var_0 )
{
    ...
    {
        var_3 = _id_0A77::_id_1302( "zmb_globproj_zm", ( 0, 0, 0 ), ( 0, 0, 0 ) );
        var_3.owner = self;
        var_3.team = self.team;
        var_3._id_13C2E = "zmb_globproj_zm";
...
_id_85CD( var_0, var_1 )
{
    ...
    var_0 thread _id_0A77::_id_C15A( "death", "end_explode" );
...
_id_85B9( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.teambased )
        var_9 = _id_0A77::_id_81A0( _id_0A77::_id_8027( self.team ) );
    else
    ...
    {
        if ( !isdefined( var_13 ) || var_13 == self || !_id_0A77::isreallyalive( var_13 ) )
            continue;
    ...
    for ( var_24 = 0; var_24 < var_2.size; var_24++ )
    {
        ...
        var_33 show();
        var_33 unlink( 1 );
        var_33 = _id_0A77::_id_1302( "zmb_globproj_zm", var_32, var_27, undefined, undefined, var_33 );
        var_33.owner = self;
        var_33.team = self.team;
        var_33._id_13C2E = "zmb_globproj_zm";
...
_id_13B91()
{
    ...
    for (;;)
    {
        ...
        if ( !_id_0A77::isreallyalive( var_2 ) )
            continue;
...
_id_13B93()
{
    ...
    for (;;)
    {
        foreach ( var_2, var_1 in self._id_127C0 )
        {
            ...
            if ( !_id_0A77::isreallyalive( var_1 ) || !var_1 istouching( self ) )
            {
                self._id_127C0[var_2] = undefined;
