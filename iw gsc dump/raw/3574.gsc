...
func_E14D(param_00,param_01)
{
	...
	for(var_02 = scripts\mp\_powers::damageconetrace(param_00) / 1000;var_02 > 0;var_02 = scripts\mp\_powers::damageconetrace(param_00) / 1000)
	{
		wait(var_02);
	}
...
func_E14C(param_00)
{
	...
	if(isdefined(self.var_C7E6) && self.var_C7E6)
	{
		...
		if(param_00)
		{
			scripts\mp\_utility::removeperk("passive_fire_damage");
		}
	}
}
...
useovercharge()
{
	...
	if(var_03)
	{
		scripts\mp\_utility::giveperk("passive_fire_damage");
	}
