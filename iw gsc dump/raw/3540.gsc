...
_id_89A2( var_0, var_1, var_2 )
{
    if ( isdefined( var_0 ) && isdefined( var_1 ) )
    {
        ...
        if ( var_3 <= 0 )
        {
            var_1 thread _id_10D9E( var_2, var_0, "passive_fire_damage", "player_plasma_friendly", "player_plasma_enemy", "j_mainroot", "player_plasma_screen_stand" );
            var_1 thread _id_10D82( var_2, var_0, 2, 0.5, 2, "passive_fire_damage" );
        }
        else
            _id_F7D7( "passive_fire_damage", 2 );
    }
}
...
_id_12F61( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_1 scripts\mp\utility\game::_id_12D6( "passive_last_shots_ammo" ) )
...
{
    if ( !isdefined( var_1 ) || !isdefined( var_0 ) || !var_1 scripts\mp\utility\game::_id_12D6( "passive_last_shots_ammo" ) )
        return;
...
_id_89CC( var_0, var_1, var_2 )
{
    ...
    {
        var_4 = scripts\mp\loot::_id_804C( var_2 );
...
_id_8974( var_0, var_1 )
{
    ...
    if ( var_0._id_204A == 0 && level.gametype != "infect" )
    {
        var_0._id_204A = 1;
