...
_id_B8B1( var_0, var_1 )
{
    ...
    else
    {
        ...
        var_16 = var_15.owner _id_0A77::_id_1302( "blackholegun_indicator_zm", self.origin, ( 0, 0, 0 ) );
        var_16._id_13C2E = "blackholegun_indicator_zm";
        var_16 linkto( var_15 );
        var_15 thread _id_BA0A( var_14, self, var_16, var_2 );
        var_1.owner thread _id_0D04::grabclosestzombies( var_15, 1 );
...
_id_13A45( var_0 )
{
    ...
    for (;;)
    {
        foreach ( var_4 in _id_0A4A::_id_7DB0( "axis" ) )
        {
            ...
            if ( !_id_0A77::isreallyalive( var_4 ) )
                continue;

            if ( !_id_0D12::_id_213D( self, var_4 ) )
                continue;

            if ( !level._id_740A && var_4 != self.owner && var_4.team != self.owner.team )
                continue;

            if ( distancesquared( var_4 geteye(), self.origin ) > var_2 )
                continue;

            _id_12896( var_4, var_4 geteye(), 1200, var_1 );
        }
...
_id_13A38( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( !_id_0A77::isreallyalive( var_3 ) )
            continue;

        if ( !_id_0D12::_id_213D( self, var_3 ) )
            continue;
        ...
        var_3 _meth_80B0( var_3.maxhealth, self.origin, self.owner, self, "MOD_EXPLOSIVE", "iw7_blackholegun_mp" );
...
_id_10212( var_0, var_1, var_2, var_3 )
{
    ...
    self _meth_8253( self.origin, 150, 2000, 500, self.owner, "MOD_EXPLOSIVE", "iw7_blackholegun_mp" );
