    ...
    for ( var_24 = 1; var_24 < var_5.size - 2; var_24++ )
    {
        ...
        if ( isdefined( var_28 ) )
        {
            ...
            if ( var_30 == "goal" )
            {
                ...
                {
                    for ( var_31 = 0; var_29[var_13]._id_735E < 18 && var_31 < 3.6; var_31 = var_31 + 0.25 )
                    {
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in self._id_1395E )
        {
            if ( var_4 )
            {
                ...
                var_2._id_1395D[self.entity_number] = var_2._id_1395D[self.entity_number] * var_6;
            }

            if ( _id_6656( var_2 ) )
                var_2._id_1395D[self.entity_number] = var_2._id_1395D[self.entity_number] * 0.5;
        }
...
_id_2E23()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in self._id_1395E )
        {
            ...
            if ( var_4 > 0.6 )
                var_2._id_1395D[self.entity_number] = var_2._id_1395D[self.entity_number] * 0.33;
            else if ( var_4 > 0 )
                var_2._id_1395D[self.entity_number] = var_2._id_1395D[self.entity_number] * 0.66;
...
_id_D924( var_0 )
{
    ...
    for ( var_2 = 0; var_2 < level._id_13FBD; var_2++ )
    {
        ...
        for ( var_4 = 0; var_4 < var_1.size; var_4++ )
        {
            ...
            if ( var_6 )
            {
                var_1[var_4]._id_1395D[self.entity_number] = var_1[var_4]._id_1395D[self.entity_number] * var_0;
