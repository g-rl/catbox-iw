...
initializematchrules()
{
	...
	scripts\mp\_utility::registerhalftimedvar("sr",0);
...
initspawns()
{
	scripts\mp\_spawnlogic::setactivespawnlogic("SearchAndRescue");
	...
	scripts\mp\_spawnlogic::addspawnpoints("attacker","mp_tdm_spawn");
	scripts\mp\_spawnlogic::addspawnpoints("attacker","mp_tdm_spawn_secondary",1,1);
	scripts\mp\_spawnlogic::addspawnpoints("defender","mp_tdm_spawn");
	scripts\mp\_spawnlogic::addspawnpoints("defender","mp_tdm_spawn_secondary",1,1);
...
getspawnpoint()
{
	...
	{
		var_01 = scripts\mp\_spawnlogic::getspawnpointarray("mp_sd_spawn_" + var_00);
...
{
	param_00 scripts\mp\_utility::setextrascore1(param_00.pers["rescues"]);
}